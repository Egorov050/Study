...
CJM тут будет следующим: открыл приложение по пушу → нашёл нужный чат в списке → написал сообщение → поставил @all → посмотрел индикаторы прочтения → написал в личку тем, кто не отреагировал.
