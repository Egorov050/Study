...
Если оптимизировать только основную, ODI покажет: пингуй настойчивее, добавь @all. Внедряем — и человек в роли получателя защищается единственным доступным рычагом, мьютом, причём необратимым. Доставляемость падает, то есть ломается та самая основная джоба, ради которой всё делалось, — включая тех же людей, которые @all и просили.

Тест, чтобы отличать на практике. Спроси про элемент: **может ли это выполняться само по себе, в другое время, без всякой ссылки на main job?** «Согласовать формальное решение» — может, это бывает вообще без чата. «Убедиться, что прочитали» — не может, оно существует только после отправки. Первое — related job, второе — шаг.
