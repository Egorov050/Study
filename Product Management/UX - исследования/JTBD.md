...
Выделяют два типа: 
1. Switch. Необходим для реконструкции пути от появления триггера в смене продукта, до момента покупки нового решения. В основе лежит четыре силы: `push обстоятельства`, `pull нового решения` (что именно привлекло), `anxiaty` (тревога по новому решению), `habb`
