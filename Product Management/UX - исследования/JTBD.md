...
**Related jobs**. Помимо основной джобы есть буквально соседние джобы, которые либо сонаправлены, либо не сонаправлены друг с другом. Может получиться так что решаю одну задачу, мы убьем другие задачи тем самым сделав только хуже. Например джоба пользователя -> упомянуть всех о важном, поэтому давайте чтобы доставляемость была выше, мы будем пинговать 
