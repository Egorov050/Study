...
<h4>Ось Y</h4>
- Точки контакта - Где пользователь взаимодействует с компанией на каждой стадии. Пример : `Этап цикла продукта` - заинтересованность. `Точка контакта` - Упоминание о компании в поисковых запросах. `Действие` - Решаю узнать о каршеринге в Москве больше и поискать информацию в Google и Yandex, зводя запрос "Каршеринг Москва"
