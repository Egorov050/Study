...
<h4>Ось Y</h4>
- Действие клиента - описание действия клиента в каждой точке контакта. Пример : Этап цикла продукта - Установка приложения , точка контакта - страничка приложения в APP
