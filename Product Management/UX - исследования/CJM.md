...
- Действие клиента - `Этап цикла продукта` - заинтересованность. `Точка контакта` - Упоминание о компании в поисковых запросах. `Действие` - Решаю узнать о каршеринге в Москве больше и поискать информацию в Google и Yandex, зводя запрос "Каршеринг Москва"
- Цели и ожидания - какие цели преследует на каждом этапе. Что он ожидает от компании. Пример : `Этап цикла продукта` - заинтересованность. `Точка контакта` - Упоминание о компании в поисковых запросах. 
