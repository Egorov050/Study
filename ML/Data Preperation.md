...
2) Support Vector Machines (SVM)**: Оптимизация гиперплоскости сильно зависит от масштаба признаков.
- **Кластеризация (например, K-Means)**: Расстояния между центроидами и точками данных зависят от масштаба признаков.