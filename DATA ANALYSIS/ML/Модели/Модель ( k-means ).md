...
Смотрим на те места, где `скорость` функции значительно `уменьшается`. В нашем случае, это точки начиная от 3 до 5. Но вопрос, как нам выбрать один кластер из массива [ 3:5 ] ? Тут на помощь приходит 
