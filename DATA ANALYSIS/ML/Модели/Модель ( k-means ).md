...
<h6>Принцип работы silhouette score</h6>
...
Среднее значение silhouette score по всем точкам дает общую оценку качества кластеризации. Соотвественно мы должны делать вывод об количестве кластеров, основываясь на обоих графиках. 
...
Здесь, мы видим, что наилучший показатель находится при k=2. Чем больше количество кластеров, чем сильнее падае
