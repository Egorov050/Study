...
Здесь, мы видим, что наилучший показатель находится при k=2. Чем больше количество кластеров, чем сильнее падает значение нашей метрики. 

При выборе количества кластеров, мы должны опираться на оба графика. Таким образом, 
