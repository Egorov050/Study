...
Допустим, в узле RRR присутствуют три класса A, B и C с долями pA=0.3p_A = 0.3pA​=0.3, pB=0.4p_B = 0.4pB​=0.4, и pC=0.3p_C = 0.3pC​=0.3 соответственно. Тогда индекс Джини для узла RRR рассчитывается следующим образом:
