...
Построение дерева:
    ...
    - **Рекурсивное разбиение**: Процесс выбора признаков и разбиения данных повторяется для каждой подгруппы, пока не выполнены условия останова (например, максимальная глубина, минимальное количество образцов в узле).
3. **Прогнозирование**:
