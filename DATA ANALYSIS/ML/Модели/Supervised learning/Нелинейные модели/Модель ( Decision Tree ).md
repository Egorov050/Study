...
<h6>Пример</h6>
Допустим, в узле RRR присутствуют `три` класса `A`, `B` и `C` с долями pA=0.3, pB​=0.4, и pC​=0.3 соответственно. Тогда индекс Джини для узла R рассчитывается следующим образом:
