...
>идея такая же. Фиксируем окно и потопали. Нам нужно тречить всегда пары : [0],[1]  и [-1], [-2]. Если у нас элемент который входит больше последнего элемента -> мы прибов
