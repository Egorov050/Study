...
Для того чтобы это сделать нужно отсортировать наш новый массив и назначить два указателя : левый (0) и правый (len(nums)-1). Если left + right дают больше и равно нуль
