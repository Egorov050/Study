...
>идея такая же. Фиксируем окно и потопали. Нам нужно тречить всегда пары : [0],[1]  и [-1], [-2]. Если у нас элемент который входит больше последнего элемента -> мы прибавляем каунтер. Если у нас длина больше чем наше заданное окно, мы удаляем последний элемент. Соответственно, если у нас удаляемый элемент ([0]) меньше чем [1] то мы удаляем подъемб 
