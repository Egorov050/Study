...
Также , даже для одного продукта может быть несколько aha-моментов. Например возьмем Miro. Два юзер-кейса. Один пользователь использует miro , чтобы строить одному майндмепы и различные приколюшки. Другой пользователь использует miro 
