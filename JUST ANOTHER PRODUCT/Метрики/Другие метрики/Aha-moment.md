...
Выбор периода для слежки также зависит от типа продукта. Если речь идет про продукт ежедневного юзкейса , то наш период один или несколько дней после регистрации. Для рабочих продуктов это можем быть неделя или месяц. Например для сервисов путешествия 
