...
Далее мы применяем нашу метрику к другой группе клиентов и посмотреть, работает ли она там. Также нужно доказать, что именно выполнение определенных действий (например, совершение 10 транзакций) увеличивает вероятность того, что клиент останется активным, а не просто совпадение. 
