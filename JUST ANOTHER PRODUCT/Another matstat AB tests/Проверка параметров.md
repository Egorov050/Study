...
Рассмотрим распределение `p-value` для АБ теста. Лучшее возможное распределение для p-value это приближение к зеркальной букве Г ( Такая же ситуация как и с ROC - кривой ) То есть 
