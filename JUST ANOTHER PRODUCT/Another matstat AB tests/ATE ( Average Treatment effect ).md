...
Однако, такая проблема может появиться из-за сетевого эффекта. Это пользователь, влияет на выбор другого пользователя. Например есть Егор и Маша. Они любят другому , а мы тестим цены на такси. И получилось так, что цена на такси у Егора и Маши разные так как мы тестим эластичность цены. Маша попала с тестовую выбок
